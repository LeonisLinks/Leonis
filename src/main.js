...
if (document.getElementById("discord")) {
    ...
    var nameElement_1 = document.getElementById("discord_name");
    var avatarElement_1 = discordElement.querySelector("img");
    var statusElement_1 = document.getElementById("discord_status");
    // @ts-ignore
    function fetchDiscord() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("http://localhost:3000/discord?i=902671568856047636")];
                    case 1:
                        res = _a.sent();
                        return [4 /*yield*/, res.json()];
                    case 2:
                        data = _a.sent();
                        nameElement_1.innerHTML = data.username;
                        avatarElement_1.src = data.avatar;
                        statusElement_1.innerHTML = data.status;
                        return [2 /*return*/];
                }
            });
        });
